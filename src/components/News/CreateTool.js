...
export default function CreateTool({ setItemNews }) {
    ...
    const [currentItem, setCurrentItem] = React.useState({ text: '', check: '', key: '' })
    ...
    const handleAddTitle = () => {
        setCurrentItem({ text: "Title name", check: "Title", key: Date.now() });
    }
    const handleAddSubTitle = () => {
        setCurrentItem({ text: "Subtitle", check: "Subtitle", key: Date.now() });
    }
    const handleAddContent = () => {
        setCurrentItem({ text: "Description", check: "Description", key: Date.now() });
    }
    const handleAddList = () => {
        setCurrentItem({ text: "List", check: "List", key: Date.now() });
    }

    const handleAddImage = () => {
        setCurrentItem({ text: "file", check: "Image", key: Date.now() });
    }
